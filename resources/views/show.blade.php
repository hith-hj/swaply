...
<div class="fullPage">
    <footer class="header mt-0 py-1 bg-light float text-center">
        <div class="container">
            ...
            <div class="">
                <svg width="140" height="70" viewBox="0 0 340 202" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="body">
            ...
            <div class="col mt-5px ani ani_fadeIn " >
                <div class="card shadow">
                    ...
                    <div class="card-footer text-center py-2 btn-group">
                        @guest
                            <a class="link-text btn btn-outline-success" href="{{ route('login') }}">تسجيل دخول</a>
                            <a class="link-text btn btn-outline-success" href="{{ url('/peek') }}">إطلاع</a><br>
