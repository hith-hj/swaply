                ...
                <x-auth-card>
                    ...
                    <div style="max-height: 60vh; min-height:50vh;overflow: auto;">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="form-group">
                            ...
                            <div class="mt-5px">
                                <x-input class="form-control-light" id="name" placeholder="{{__('اسم المستخدم')}}" type="text" name="name" :value="old('name')" required autofocus autocomplete="name"/>
                            </div>
                           ...
                           <div class=" mt-5px" >
                            ...
                            <a class="cb sbtn-txt" href="{{ route('login') }}">
                                {{ __('لدي حساب') }}
                            </a>
                        </form>
                    </div>
