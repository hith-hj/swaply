...
class Dropdown extends BaseComponent {
    ...
    show() {
        ...
        if (!EventHandler.trigger(this._element, EVENT_SHOW$4, t)
            .defaultPrevented
        ) {
            if (this._inNavbar)
...
class Modal extends BaseComponent {
    ...
    hide(e) {
        if (
            (e && ["A", "AREA"].includes(e.target.tagName) &&
                e.preventDefault(), !this._isShown || this._isTransitioning)
        )
            return;
