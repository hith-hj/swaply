...
!(function(e, t) {
    ...
    function f(e, t, n, i = {}) {
        return d(
            ...
            )(n, ...Object.values(i)), { el: e, expression: t }
        );
    }
    const m =
    ...
    function O(e, t, n) {
        ...
        return "origin" === t && ["top", "right", "left", "center", "bottom"].includes(
                e[e.indexOf(t) + 2]
            ) ?
    ...
    function T(e, t, n, r, o, l, c) {
        ...
        if ("value" === n) {
            ...
            if (
                ...
                "boolean" == typeof u || [null, void 0].includes(u) ||
                "bind" !== l ?
                "bind" !== l &&
                (Array.isArray(u) ?
            ...
            (n = c.includes("camel") ? a(n) : n), [null, void 0, !1].includes(u) ?
            t.removeAttribute(n) :
            !(function(e) {
                return [
                    "disabled",
    ...
    const { isArray: M } = Array, {
        ...
        preventExtensions: Z,
        hasOwnProperty: J,
    } = Object, { push: Q, concat: X, map: Y } = Array.prototype;
        ...
        constructor(e) {
            if (
                ((this.valueDistortion = he),
                    ...
                    (this.objectGraph = new WeakMap()), !ee(e))
            ) {
                const {
                    valueDistortion: t,
                    valueMutated: n,
                ...
                ({ type: i, value: r, modifiers: s, expression: o }) => {
                    switch (i) {
                        ...
                        case "model":
                            !(function(e, t, i, r, s) {
                                var o =
                                    "select" === t.tagName.toLowerCase() || ["checkbox", "radio"].includes(t.type) ||
                                    i.includes("lazy") ?
                                    "change" :
                                    "input";
                                N(
